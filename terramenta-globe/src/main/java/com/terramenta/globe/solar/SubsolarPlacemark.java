 ...
 */
public class SubsolarPlacemark extends PointPlacemark {

    public SubsolarPlacemark() {
        super(Position.ZERO);

        setValue(AVKey.DISPLAY_NAME, "Subsolar Point");
        setValue(AVKey.DISPLAY_ICON, "com/terramenta/globe/solar/sun.png");//16x16
        ...
        URL resource = getClass().getResource("/" + getValue(AVKey.DISPLAY_ICON));
        if (resource != null) {
