 ...
 *
 * This work is subject to the terms of either the GNU General Public License Version 3 ("GPL") or
 * the Common Development and Distribution License("CDDL") (collectively, the "License"). You may
...
public interface DatetimeChangeListener {
    ...
    void onDatetimeChange(Instant oldDatetime, Instant newDatetime);
}
