 ...
 */
public class Office2013RichTooltipPanelUI extends BasicRichTooltipPanelUI {

    public static ComponentUI createUI(JComponent c) {
        return new Office2013RichTooltipPanelUI();
    }

    @Override
    protected void paintBackground(Graphics g) {
        Graphics2D g2d = (Graphics2D) g.create();
        g2d.setColor(FlamingoUtilities.getColor(Color.lightGray, "RichTooltipPanel.background", "Panel.background"));
