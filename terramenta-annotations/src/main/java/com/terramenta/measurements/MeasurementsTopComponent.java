...
@NbBundle.Messages({
    ...
    "CTL_MeasurementsAction_TooltipTitle=Advanced Measurements",
    "CTL_MeasurementsAction_TooltipBody=Allows point to point distance measurements on the Globe and Terrain Profiling.",
...
public final class MeasurementsTopComponent extends TopComponent {
    ...
    private static MeasureTool measureTool;
    private static TerrainProfileLayer profile;
    ...
    private void initMeasureTool() {
        ...
        measureTool = new MeasureTool(wwm.getWorldWindow());
